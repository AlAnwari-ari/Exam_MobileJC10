        ...
        return (
            <View>
                ...
                <View style={{ paddingTop: 15 }}>
                    <Text style={{ paddingLeft: 12, opacity: 0.3 }}>Username</Text>
                    <Input 
...
export default connect(mapStateToProps, { inputUsernameChange, imageProfileChange, saveProfile })(EditProfile);